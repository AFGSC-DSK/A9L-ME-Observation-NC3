...
packages:
  ...
  /gd-bs/5.5.0:
    ...
    dev: false
    resolution:
      integrity: sha512-e3fEsxHLrjv+ifITmxk34YLOuzhjkBwzrhfkahbbKuxR4K8AOWuETuVKUjarNRNi25SrZuUi+gn0pHpGiRHxfQ==
  /gd-sprest-def/1.1.0:
    dev: false
    resolution:
      integrity: sha512-0uicOpS2ONpg3T9HQ1djoBmOPNbUgnUs6VJhYPsR1j3c64rmKBYZmeyUrUN2+1jwPcEcoe39X/XZDgiItLugaw==
  /gd-sprest/6.9.7:
    dependencies:
      gd-sprest-def: 1.1.0
    dev: false
    resolution:
      integrity: sha512-FDW6HWt1Njgj6EBWuxfa532iAw1wmWZKDtc8qTwMDZIwAss6QItWfUqywG1J/UmG+BAqdhSf+hmol6raF8SmNA==
  /gensync/1.0.0-beta.2:
    dev: true
    engines:
      node: '>=6.9.0'
